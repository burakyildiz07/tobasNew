            ...
            <div class="col-md-12">
                <div class="panel panel-crm">
                    <div class="panel-heading">
                        <h1><i class="fa fa-eye" aria-hidden="true"></i> İçerikleri Görüntüle</h1>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-justified" role="group">
                                                ...
                                                <div class="btn-group" role="group">
                                                    <a type="button" class="btn btn-xs btn-warning" href="{{route('manager.content-edit',$content->id)}}" role="button"><span class="fa fa-pencil" aria-hidden="true"></span></a>
                                                </div>
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#removeModal" data-id="{{$content->id}}" data-name="{{$content->title}}">
