            ...
            <div class="col-md-12">
                <div class="panel panel-crm">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('url'=>route('manager.pages-create-post'),'method'=>'post','autocomplete'=>'off')) }}
                        <div class="row">
                            <div class="form-group col-md-12">
                                {{ Form::label('sayfaAdi', 'Sayfa Adı')}}
                                <div class="input-group input-group-lg">
                                    <span class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                                    {{ Form::text('sayfaAdi','',array('class'=>'form-control','id'=>'sayfaAdi','placeholder'=>'Sayfa Adı')) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
