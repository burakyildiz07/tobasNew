...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6 auth-box">
                {{ Form::open(array('url'=>route('login'), 'method'=>'post', 'id'=>'auth-form', 'autocomplete'=>'off')) }}
                <div class="row">
                    <div class="form-group form-group-lg col-md-12">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span>
                            {{ Form::text('email', '', array('id' => 'email', 'class' => 'form-control', 'placeholder' => 'Kullanıcı adınızı girin')) }}
                            @if ($errors->has('email'))
